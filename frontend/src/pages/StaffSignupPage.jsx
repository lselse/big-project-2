    ...
    <main className="auth-container">
      <div className="auth-box staff-auth">
        ...
        <div className="auth-header">
          ...
          <h1>운영자 회원가입</h1>
          <p>이메일 인증 후 가입을 신청하면 ADMIN 승인 뒤 계정을 사용할 수 있습니다.</p>
        </div>
        ...
        <form onSubmit={submit} className="staff-login-form">
          ...
          <button className="primary-button" type="submit" disabled={loading || !verificationToken} style={{ width: '100%', marginTop: '0.5rem' }}>
